...
public class OnOffPreferences extends PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		addPreferencesFromResource(R.xml.onoffprefers);
		// android:key="OffCategory"
		prefs = PreferenceManager.getDefaultSharedPreferences(getBaseContext());
		OffCategory = (Preference) findPreference("OffCategory");
		OnCategory = (Preference) findPreference("OnCategory");
		InputFile = (Preference) findPreference("custFile");
		onPref = (CheckBoxPreference) findPreference("OnGps");
		
		// when a click event is creating
		offPref = (CheckBoxPreference) findPreference("OffGps");
		...
		InputFile.setOnPreferenceClickListener(new OnPreferenceClickListener() {
			...
			public boolean onPreferenceClick(Preference preference) {
				...
				Intent i = new Intent(OnOffPreferences.this, EditTextBrowser.class);
				startActivity(i);
				return false;
			}
		});
